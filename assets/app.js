...
function open_earn() {
    ...
    ad1 = ads1[random_num];
    add.innerHTML = '<center><br><iframe width="560" height="315" src="https://www.youtube.com/embed/videoseries?list=PLj1jjqEw6eMuMsoGykrygkBgVarXYN0Pu&index=' + random_num + '&autoplay=1" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe><br><br>' + ad1 + '<br><button class="home-button" style="top: 90%;" onclick="stop_earn()">Stop Earning</button></center>';
    window.open(link);
    timer();
}
function stop_earn() {
